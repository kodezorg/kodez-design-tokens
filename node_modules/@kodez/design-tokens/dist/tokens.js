...
export const lightTokens = {
    ...
    // ── Portal gradients ──────────────────────────────────────────────────────────
    'page-gradient': 'radial-gradient(ellipse at 16% 14%,rgba(81,83,246,0.08),transparent 30%),radial-gradient(ellipse at 86% 76%,rgba(255,127,86,0.06),transparent 30%)',
    'page-gradient-muted': 'radial-gradient(ellipse at 12% 18%,rgba(81,83,246,0.05),transparent 28%),radial-gradient(ellipse at 84% 78%,rgba(81,83,246,0.04),transparent 28%)',
    'portal-hero-bg': 'linear-gradient(135deg,rgba(255,255,255,0.98),rgba(245,247,250,0.96)),radial-gradient(ellipse at 84% 18%,rgba(81,83,246,0.10),transparent 28%)',
};
export const darkTokens = {
    ...
    // ── Portal gradients ──────────────────────────────────────────────────────────
    'page-gradient': 'radial-gradient(ellipse at 18% 10%,rgba(81,83,246,0.18),transparent 40%),radial-gradient(ellipse at 86% 78%,rgba(255,127,86,0.10),transparent 35%)',
    'page-gradient-muted': 'radial-gradient(ellipse at 50% 40%,rgba(81,83,246,0.12),transparent 68%)',
    'portal-hero-bg': 'radial-gradient(ellipse at 50% 40%,rgba(81,83,246,0.12) 0%,transparent 68%)',
};
